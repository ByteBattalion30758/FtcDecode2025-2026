...
public class AutoStateFactory9 extends LinearOpMode {
    ...
    private Pose scorePose = new Pose(48, 85, Math.toRadians(134));
    private Pose lastscorePose = new Pose(50, 95, Math.toRadians(143));
    ...
    private Pose intake2Pose = new Pose(1, 58, Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StateMachine kickerMachine = new StateMachineBuilder()
                ...
                .onEnter(()->kickerServo.setPosition(Teleop.kickerDownPos))
                .transition(()->kick)
                .state(KickerStates.Up1)
                .onEnter(()->{
                    kickerServo.setPosition(Teleop.kickerUpPos);
                    kick=false;
                })
                .transitionTimed(0.4)
                ...
                .onEnter(()->kickerServo.setPosition(Teleop.kickerUpPos))
                .transitionTimed(0.4)
