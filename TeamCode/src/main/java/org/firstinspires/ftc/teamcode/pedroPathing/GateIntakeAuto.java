...
@Autonomous
public class GateIntakeAuto extends LinearOpMode {
    ...
    private Pose gateIntake = new Pose(7,56, Math.toRadians(135));

    private Pose gateIntakeControlPoint = new Pose(7,56, Math.toRadians(135));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PathChain scorePosetoGateIntake = follower.pathBuilder().addPath(new BezierCurve(scorePose, gateIntakeControlPoint, gateIntake))
                .addParametricCallback(0.3, () -> follower.setMaxPower(0.5))
                .setLinearHeadingInterpolation(intake2Pose.getHeading(), intake2PoseAlignment.getHeading(), intake2PoseControlPoint.getHeading())
                .build();

        PathChain GateIntaketoScorePose = follower.pathBuilder().addPath(new BezierCurve(gateIntake, gateIntakeControlPoint, scorePose))
                .addParametricCallback(0.3, () -> follower.setMaxPower(0.5))
                .setLinearHeadingInterpolation(intake2Pose.getHeading(), intake2PoseAlignment.getHeading(), intake2PoseControlPoint.getHeading())
                .build();
        ...
        StateMachine autoMachine = new StateMachineBuilder()
                ...
                //.state(AutoStates.openGateIntake)
                .onEnter(() -> follower.followPath(scorePosetoGateIntake))
                .transition(() -> !follower.isBusy())
                .transitionTimed(2)
                ...
                .state(AutoStates.openGateIntake2)
                .onEnter(() -> follower.followPath(scorePosetoGateIntake))
                .transition(() -> !follower.isBusy())
                .transitionTimed(2)
